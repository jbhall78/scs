...
slist_t *
slist_unlink(slist_t *head, slist_t *del)
{
    slist_t *prev = NULL;
    slist_t *item;
...
slist_t *
slist_remove(slist_t *head, slist_t *del, void (*free_data_cb)(void *))
{
    slist_t *prev = NULL;
    slist_t *item;
...
void
slist_destroy(slist_t *head, void (*free_data_cb)(void *))
{
    slist_t *item, *next;
